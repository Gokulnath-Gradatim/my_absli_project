...
public class MasterPolicyPageDemo extends AbsliBase {
	...
	public MasterPolicyPageDemo()
	{
		PageFactory.initElements(driver, this);
	}
	
	public void createAMasterPolicyWithMandatoryFields() throws Exception 
	{
		...
		Thread.sleep(3000);
		Select contactPersonTitleSelect = new Select(contactPersonTitle);
		contactPersonTitleSelect.selectByVisibleText("Mr");
		Thread.sleep(3000);
