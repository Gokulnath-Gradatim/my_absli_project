...
public class TC_MPM_029_MasterPolicyWith6BenefitsAndRidersWithVariantTypeAsCRRCCC extends AbsliBase {
	...
	@DataProvider(name="TestDataFromTC_MPM_029")
	public Object[][] getTestDataFromTestDataFromTC_MPM_029()
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_029.xlsx", "TC_MPM_029");
		return arrobj;			
	}
	
	@Test(priority = 28,dataProvider = "TestDataFromTC_MPM_029", dataProviderClass = TC_MPM_029_MasterPolicyWith6BenefitsAndRidersWithVariantTypeAsCRRCCC.class)
	public void createAMasterPolicyWith4BenefitsAndRidersWithVariantTypeAsCRRCCC (String clientName, String agreementNumberStringValue, String quotationDetailsStringValue, 
			...
			String benefits6, String varientType6, String freeCoverLimitValue6) throws Throwable
	{
		...
		masterPolicyMakerPage.masterPolicyWith6BenefitsAndRidersWithVariantTypeAsCRRCCC(clientName, 
				...
				windowPeriodValue, nraLetterReceived, retirementAgeValue, nraLetterReceivedDateValue, 
				typeOfClient, frequency, zone, minimumAge, maximumAge, reinsurerValue, UnitAddress, 
				addressDetails, benefits1, varientType1, freeCoverLimitValueForBaseBenefit, benefits2, 
				...
				freeCoverLimitValue4, benefits5, varientType5, freeCoverLimitValue5, benefits6, varientType6, 
