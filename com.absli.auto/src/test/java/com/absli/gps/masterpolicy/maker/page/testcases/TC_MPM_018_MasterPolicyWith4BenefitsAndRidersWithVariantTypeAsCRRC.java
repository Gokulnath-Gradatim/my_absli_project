...
public class TC_MPM_018_MasterPolicyWith4BenefitsAndRidersWithVariantTypeAsCRRC extends AbsliBase {
	...
	@DataProvider(name="TestDataFromTC_MPM_018")
	public Object[][] getTestDataFromTestDataFromTC_MPM_018()
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_018.xlsx", "TC_MPM_018");
		return arrobj;			
	}
	
	@Test(priority = 17,dataProvider = "TestDataFromTC_MPM_018", dataProviderClass = TC_MPM_018_MasterPolicyWith4BenefitsAndRidersWithVariantTypeAsCRRC.class)
	public void createAMasterPolicyWith4BenefitsAndRidersWithVariantTypeAsCRRC(String clientName, String agreementNumberStringValue, String quotationDetailsStringValue, 
			...
			String minimumCapValueForAdditionalRider, String maximumCapValueForAdditionalRider, String benefits4, String varientType4, String freeCoverLimitValue) throws Throwable
	{
		...
		masterPolicyMakerPage.masterPolicyWith4BenefitsAndRidersWithVariantTypeAsCRRC(clientName, agreementNumberStringValue, 
				...
				benefits4, varientType4, freeCoverLimitValue);
	}
