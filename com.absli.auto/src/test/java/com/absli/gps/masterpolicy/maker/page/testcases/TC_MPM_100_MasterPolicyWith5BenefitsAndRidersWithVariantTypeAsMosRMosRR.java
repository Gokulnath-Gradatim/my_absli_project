...
public class TC_MPM_100_MasterPolicyWith5BenefitsAndRidersWithVariantTypeAsMosRMosRR  extends AbsliBase {
	...
	@DataProvider(name="TestDataFromTC_MPM_100")
	public Object[][] getTestDataFromTestDataFromTC_MPM_100()
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_100.xlsx", "TC_MPM_100");
		return arrobj;
	}
	
	@Test(priority = 99,dataProvider = "TestDataFromTC_MPM_100", dataProviderClass = TC_MPM_100_MasterPolicyWith5BenefitsAndRidersWithVariantTypeAsMosRMosRR.class)
	public void createAMasterPolicyWith5BenefitsAndRidersWithVariantTypeAsMosRMosRR (String clientName, String agreementNumberStringValue, String quotationDetailsStringValue, 
		...
		masterPolicyMakerPage.masterPolicyWith5BenefitsAndRidersWithVariantTypeAsMosRMosRR(clientName, agreementNumberStringValue, 
