...
public class TC_MPM_036_MasterPolicyWith6BenefitsAndRidersWithVariantTypeAsCRRCCR extends AbsliBase {
	...
	@DataProvider(name="TestDataFromTC_MPM_036")
	public Object[][] getTestDataFromTestDataFromTC_MPM_036()
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_036.xlsx", "TC_MPM_036");
		return arrobj;			
	}
	
	@Test(priority = 35,dataProvider = "TestDataFromTC_MPM_036", dataProviderClass = TC_MPM_036_MasterPolicyWith6BenefitsAndRidersWithVariantTypeAsCRRCCR.class)
	public void createAMasterPolicyWith4BenefitsAndRidersWithVariantTypeAsCRRCCR (String clientName, String agreementNumberStringValue, String quotationDetailsStringValue, 
			...
			String benefits6, String varientType6, String percentageofBaseBenefitValue6, String freeCoverLimitValue6, String minimumCapValue6, String maximumCapValue6) throws Throwable
	{
		...
		masterPolicyMakerPage.masterPolicyWith6BenefitsAndRidersWithVariantTypeAsCRRCCR(clientName, 
				...
				percentageofBaseBenefitValue6, freeCoverLimitValue6, minimumCapValue6, maximumCapValue6);
	}
