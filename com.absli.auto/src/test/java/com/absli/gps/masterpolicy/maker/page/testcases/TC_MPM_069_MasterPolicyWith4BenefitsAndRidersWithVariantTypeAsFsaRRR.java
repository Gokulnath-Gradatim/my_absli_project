...
public class TC_MPM_069_MasterPolicyWith4BenefitsAndRidersWithVariantTypeAsFsaRRR extends AbsliBase {
	...
	@DataProvider(name="TestDataFromTC_MPM_069")
	public Object[][] getTestDataFromTestDataFromTC_MPM_069()
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_069.xlsx", "TC_MPM_069");
		return arrobj;
			
	}
	
	@Test(priority = 68,dataProvider = "TestDataFromTC_MPM_069", dataProviderClass = TC_MPM_069_MasterPolicyWith4BenefitsAndRidersWithVariantTypeAsFsaRRR.class)
	public void createAMasterPolicyWith4BenefitsAndRidersWithVariantTypeAsFsaRRR(String clientName, String agreementNumberStringValue, String quotationDetailsStringValue, 
			...
			String benefits4, String varientType4, String percentageofBaseBenefitValue4, String freeCoverLimitValue4, String minimumCapValue4, String maximumCapValue4) throws Throwable
	{
		...
		masterPolicyMakerPage.masterPolicyWith4BenefitsAndRidersWithVariantTypeAsFsaRRR(clientName, 
