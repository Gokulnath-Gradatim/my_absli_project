...
public class TC_MPM_037_MasterPolicyWith6BenefitsAndRidersWithVariantTypeAsCRRRRC extends AbsliBase{
	...
	@DataProvider(name="TestDataFromTC_MPM_037")
	public Object[][] getTestDataFromTestDataFromTC_MPM_037()
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_037.xlsx", "TC_MPM_037");
		return arrobj;			
	}
	
	@Test(priority = 36,dataProvider = "TestDataFromTC_MPM_037", dataProviderClass = TC_MPM_037_MasterPolicyWith6BenefitsAndRidersWithVariantTypeAsCRRRRC.class)
	public void createAMasterPolicyWith4BenefitsAndRidersWithVariantTypeAsCRRRRC (String clientName, String agreementNumberStringValue, String quotationDetailsStringValue, 
			...
			String benefits6, String varientType6, String freeCoverLimitValue6) throws Throwable
	{
		...
		masterPolicyMakerPage.masterPolicyWith6BenefitsAndRidersWithVariantTypeAsCRRRRC(clientName, 
				...
				benefits6, varientType6, freeCoverLimitValue6);
	}
