...
public class TC_MPM_114_MasterPolicyWith5BenefitsAndRidersWithVariantTypeAsFsgaRRRFsga extends AbsliBase {
	...
	@DataProvider(name="TestDataFromTC_MPM_114")
	public Object[][] getTestDataFromTestDataFromTC_MPM_114()
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_114.xlsx", "TC_MPM_114");
		return arrobj;
	}
	
	@Test(priority = 113,dataProvider = "TestDataFromTC_MPM_114", dataProviderClass = TC_MPM_114_MasterPolicyWith5BenefitsAndRidersWithVariantTypeAsFsgaRRRFsga.class)
	public void createAMasterPolicyWith5BenefitsAndRidersWithVariantTypeAsFsgaRRRFsga (String clientName, String agreementNumberStringValue, String quotationDetailsStringValue, 
		...
		masterPolicyMakerPage.masterPolicyWith5BenefitsAndRidersWithVariantTypeAsFsgaRRRFsga(clientName, agreementNumberStringValue, 
				...
				benefits5, varientType5, retirementAgeValue5, maxSumAssuredValue5, freeCoverLimitValue5, minimumCapValue5, 
				maximumCapValue5);
	}
