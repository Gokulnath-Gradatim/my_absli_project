...
public class TC_MPM_063_MasterPolicyWith3BenefitsAndRidersWithVariantTypeAsFsgaRR extends AbsliBase  {
	...
	@DataProvider(name="TestDataFromTC_MPM_063")
	public Object[][] getTestDataFromTestDataFromTC_MPM_063()
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_063.xlsx", "TC_MPM_063");
		return arrobj;
			
	}
	
	@Test(priority = 62,dataProvider = "TestDataFromTC_MPM_063", dataProviderClass = TC_MPM_063_MasterPolicyWith3BenefitsAndRidersWithVariantTypeAsFsgaRR.class)
	public void createAMasterPolicyWith3BenefitsAndRidersWithVariantTypeAsFsgaRR(String clientName, String agreementNumberStringValue, String quotationDetailsStringValue, 
			...
			String benefits3,String varientType3,  String percentageofBaseBenefitValueForAdditionalRider, String freeCoverLimitValueForAdditionalRider, String minimumCapValueForAdditionalRider, String maximumCapValueForAdditionalRider) throws Throwable
	{
		...
		masterPolicyMakerPage.masterPolicyWith3BenefitsAndRidersWithVariantTypeAsFsgaRR(clientName, agreementNumberStringValue, 
