...
public class TC_MPM_056_MasterPolicyWith3BenefitsAndRidersWithVariantTypeAsFsaRFsa extends AbsliBase  {
	...
	@DataProvider(name="TestDataFromTC_MPM_056")
	public Object[][] getTestDataFromTestDataFromTC_MPM_056()
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_056.xlsx", "TC_MPM_056");
		return arrobj;
				
	}
	
	@Test(priority = 55,dataProvider = "TestDataFromTC_MPM_056", dataProviderClass = TC_MPM_056_MasterPolicyWith3BenefitsAndRidersWithVariantTypeAsFsaRFsa.class)
	public void createAMasterPolicyWith3BenefitsAndRidersWithVariantTypeAsFsaRFsa(String clientName, String agreementNumberStringValue, String quotationDetailsStringValue, 
			...
			String benefits3, String varientType3, String sumAssuredValueForAdditionalRider, String freeCoverLimitValueForAdditionalRider) throws Throwable
	{
		...
		masterPolicyMakerPage.masterPolicyWith3BenefitsAndRidersWithVariantTypeAsFsaRFsa(clientName, 
				...
				maximumAge, reinsurerValue, unitAddress, addressDetails, benefits1, varientType1, 
				sumAssuredValueForBaseBenefit, freeCoverLimitValueForBaseBenefit, benefits2, varientType2, 
				...
				sumAssuredValueForAdditionalRider, freeCoverLimitValueForAdditionalRider);
	}
