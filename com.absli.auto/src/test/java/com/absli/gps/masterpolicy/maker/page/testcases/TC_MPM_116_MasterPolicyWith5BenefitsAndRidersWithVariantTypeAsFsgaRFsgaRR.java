...
public class TC_MPM_116_MasterPolicyWith5BenefitsAndRidersWithVariantTypeAsFsgaRFsgaRR extends AbsliBase {
	...
	@DataProvider(name="TestDataFromTC_MPM_116")
	public Object[][] getTestDataFromTestDataFromTC_MPM_116()
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_116.xlsx", "TC_MPM_116");
		return arrobj;
	}
	
	@Test(priority = 115,dataProvider = "TestDataFromTC_MPM_116", dataProviderClass = TC_MPM_116_MasterPolicyWith5BenefitsAndRidersWithVariantTypeAsFsgaRFsgaRR.class)
	public void createAMasterPolicyWith5BenefitsAndRidersWithVariantTypeAsFsgaRFsgaRR (String clientName, String agreementNumberStringValue, String quotationDetailsStringValue, 
		...
		masterPolicyMakerPage.masterPolicyWith5BenefitsAndRidersWithVariantTypeAsFsgaRFsgaRR(clientName, agreementNumberStringValue, 
				...
				minimumCapValue4, maximumCapValue4, benefits5, varientType5, percentageofBaseBenefitValue5, freeCoverLimitValue5, 
