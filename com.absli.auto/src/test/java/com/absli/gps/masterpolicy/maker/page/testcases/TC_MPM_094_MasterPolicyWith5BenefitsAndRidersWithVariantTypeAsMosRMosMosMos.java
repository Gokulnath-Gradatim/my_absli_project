...
public class TC_MPM_094_MasterPolicyWith5BenefitsAndRidersWithVariantTypeAsMosRMosMosMos extends AbsliBase {
	...
	@DataProvider(name="TestDataFromTC_MPM_094")
	public Object[][] getTestDataFromTestDataFromTC_MPM_094()
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_094.xlsx", "TC_MPM_094");
		return arrobj;
	}
	
	@Test(priority = 93,dataProvider = "TestDataFromTC_MPM_094", dataProviderClass = TC_MPM_094_MasterPolicyWith5BenefitsAndRidersWithVariantTypeAsMosRMosMosMos.class)
	public void createAMasterPolicyWith5BenefitsAndRidersWithVariantTypeAsMosRMosMosMos (String clientName, String agreementNumberStringValue, String quotationDetailsStringValue, 
		...
		masterPolicyMakerPage.masterPolicyWith5BenefitsAndRidersWithVariantTypeAsMosRMosMosMos(clientName, agreementNumberStringValue, 
				...
				multiplesOfSalaryValue5, freeCoverLimitValue5, minimumCapValue5, maximumCapValue5);
	}
