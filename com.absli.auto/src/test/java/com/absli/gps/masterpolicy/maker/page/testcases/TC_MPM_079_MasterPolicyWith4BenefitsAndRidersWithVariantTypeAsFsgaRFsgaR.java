...
public class TC_MPM_079_MasterPolicyWith4BenefitsAndRidersWithVariantTypeAsFsgaRFsgaR extends AbsliBase {
	...
	public void createAMasterPolicyWith4BenefitsAndRidersWithVariantTypeAsFsgaRFsgaR(String clientName, String agreementNumberStringValue, String quotationDetailsStringValue, 
		...
		masterPolicyMakerPage.masterPolicyWith4BenefitsAndRidersWithVariantTypeAsFsgaRFsgaR(clientName, agreementNumberStringValue, 
				...
				windowPeriodValue, nraLetterReceived, retirementAgeValue, nraLetterReceivedDateValue, typeOfClient, frequency, zone, minimumAge, 
				maximumAge, reinsurerValue, unitAddress, addressDetails, benefits1, varientType1, retirementAgeValueForBaseBenefit, 
				maxSumAssuredValueForBaseBenefit, freeCoverLimitValueForBaseBenefit, minimumCapValueForBaseBenefit, maximumCapValueForBaseBenefit, 
				benefits2, varientType2, percentageofBaseBenefitValueForInbuildRider, freeCoverLimitValueForInbuildRider, 
				minimumCapValueForInbuildRider, maximumCapValueForInbuildRider, benefits3, varientType3, retirementAgeValueForAdditionalRider, 
