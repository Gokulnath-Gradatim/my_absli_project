...
public class TC_MPM_103_MasterPolicyWith5BenefitsAndRidersWithVariantTypeAsGcRGcRGc extends AbsliBase {
	...
	@DataProvider(name="TestDataFromTC_MPM_103")
	public Object[][] getTestDataFromTestDataFromTC_MPM_103()
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_103.xlsx", "TC_MPM_103");
		return arrobj;
	}
	
	@Test(priority = 102,dataProvider = "TestDataFromTC_MPM_103", dataProviderClass = TC_MPM_103_MasterPolicyWith5BenefitsAndRidersWithVariantTypeAsGcRGcRGc.class)
	public void createAMasterPolicyWith5BenefitsAndRidersWithVariantTypeAsGcRGcRGc (String clientName, String agreementNumberStringValue, String quotationDetailsStringValue, 
		...
		masterPolicyMakerPage.masterPolicyWith5BenefitsAndRidersWithVariantTypeAsGcRGcRGc(clientName, agreementNumberStringValue, 
				...
				benefits5, varientType5, gradeValueForFifthRider1, sumAssuredValueForFifthRider1, freeCoverLimitValueForFifthRider1, 
