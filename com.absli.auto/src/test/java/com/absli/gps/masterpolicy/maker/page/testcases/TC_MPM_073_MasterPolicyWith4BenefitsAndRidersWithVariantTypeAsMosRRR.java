...
public class TC_MPM_073_MasterPolicyWith4BenefitsAndRidersWithVariantTypeAsMosRRR extends AbsliBase {
	...
	@DataProvider(name="TestDataFromTC_MPM_073")
	public Object[][] getTestDataFromTestDataFromTC_MPM_073()
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_073.xlsx", "TC_MPM_073");
		return arrobj;
			
	}
	
	@Test(priority = 72,dataProvider = "TestDataFromTC_MPM_073", dataProviderClass = TC_MPM_073_MasterPolicyWith4BenefitsAndRidersWithVariantTypeAsMosRRR.class)
	public void createAMasterPolicyWith4BenefitsAndRidersWithVariantTypeAsMosRRR(String clientName, String agreementNumberStringValue, String quotationDetailsStringValue, 
		...
		masterPolicyMakerPage.masterPolicyWith4BenefitsAndRidersWithVariantTypeAsMosRRR(clientName, agreementNumberStringValue, 
