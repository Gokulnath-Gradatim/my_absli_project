...
public class TC_MPM_024_MasterPolicyWith5BenefitsAndRidersWithVariantTypeAsCRRRC extends AbsliBase {
	...
	@DataProvider(name="TestDataFromTC_MPM_024")
	public Object[][] getTestDataFromTestDataFromTC_MPM_024()
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_024.xlsx", "TC_MPM_024");
		return arrobj;			
	}
	
	@Test(priority = 23,dataProvider = "TestDataFromTC_MPM_024", dataProviderClass = TC_MPM_024_MasterPolicyWith5BenefitsAndRidersWithVariantTypeAsCRRRC.class)
	public void createAMasterPolicyWith4BenefitsAndRidersWithVariantTypeAsCRRRC(String clientName, String agreementNumberStringValue, String quotationDetailsStringValue, 
			...
			String benefits5, String varientType5, String freeCoverLimitValue5) throws Throwable
	{
		...
		masterPolicyMakerPage.masterPolicyWith5BenefitsAndRidersWithVariantTypeAsCRRRC(clientName, agreementNumberStringValue, 
				...
				benefits5, varientType5, freeCoverLimitValue5);
	}
