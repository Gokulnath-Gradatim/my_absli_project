...
public class TC_MPM_019_MasterPolicyWith4BenefitsAndRidersWithVariantTypeAsCRRR extends AbsliBase {
	...
	@DataProvider(name="TestDataFromTC_MPM_019")
	public Object[][] getTestDataFromTestDataFromTC_MPM_019()
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_019.xlsx", "TC_MPM_019");
		return arrobj;			
	}
	
	@Test(priority = 18,dataProvider = "TestDataFromTC_MPM_019", dataProviderClass = TC_MPM_019_MasterPolicyWith4BenefitsAndRidersWithVariantTypeAsCRRR.class)
	public void createAMasterPolicyWith4BenefitsAndRidersWithVariantTypeAsCRRR(String clientName, String agreementNumberStringValue, String quotationDetailsStringValue, 
			...
			String minimumCapValue4, String maximumCapValue4) throws Throwable
	{
		...
		masterPolicyMakerPage.masterPolicyWith4BenefitsAndRidersWithVariantTypeAsCRRR(clientName, agreementNumberStringValue, 
				...
				benefits4, varientType4, percentageofofBaseBenefitValue4, freeCoverLimitValue4, minimumCapValue4, 
				maximumCapValue4);
	}
