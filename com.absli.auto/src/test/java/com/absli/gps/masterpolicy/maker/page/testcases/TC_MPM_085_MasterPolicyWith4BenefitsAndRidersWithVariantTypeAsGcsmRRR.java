...
public class TC_MPM_085_MasterPolicyWith4BenefitsAndRidersWithVariantTypeAsGcsmRRR extends AbsliBase {
	...
	@DataProvider(name="TestDataFromTC_MPM_085")
	public Object[][] getTestDataFromTestDataFromTC_MPM_085()
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_085.xlsx", "TC_MPM_085");
		return arrobj;
			
	}
	
	@Test(priority = 84,dataProvider = "TestDataFromTC_MPM_085", dataProviderClass = TC_MPM_085_MasterPolicyWith4BenefitsAndRidersWithVariantTypeAsGcsmRRR.class)
	public void createAMasterPolicyWith4BenefitsAndRidersWithVariantTypeAsGcsmRRR (String clientName, String agreementNumberStringValue, String quotationDetailsStringValue, 
		...
		masterPolicyMakerPage.masterPolicyWith4BenefitsAndRidersWithVariantTypeAsGcsmRRR(clientName, agreementNumberStringValue, 
