...
public class TC_MPM_027_MasterPolicyWith5BenefitsAndRidersWithVariantTypeAsCRRRR extends AbsliBase{
	...
	@DataProvider(name="TestDataFromTC_MPM_027")
	public Object[][] getTestDataFromTestDataFromTC_MPM_027()
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_027.xlsx", "TC_MPM_027");
		return arrobj;			
	}
	
	@Test(priority = 26,dataProvider = "TestDataFromTC_MPM_027", dataProviderClass = TC_MPM_027_MasterPolicyWith5BenefitsAndRidersWithVariantTypeAsCRRRR.class)
	public void createAMasterPolicyWith4BenefitsAndRidersWithVariantTypeAsCRRRR (String clientName, String agreementNumberStringValue, String quotationDetailsStringValue, 
			...
			String benefits5, String varientType5, String percentageofBaseBenefitValue5, String freeCoverLimitValue5, String minimumCapValue5, String maximumCapValue5) throws Throwable
	{
		...
		masterPolicyMakerPage.masterPolicyWith5BenefitsAndRidersWithVariantTypeAsCRRRR(clientName, 
