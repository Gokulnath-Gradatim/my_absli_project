...
public class TC_MPM_017_MasterPolicyWith4BenefitsAndRidersWithVariantTypeAsCRCR extends AbsliBase {
	...
	public void createAMasterPolicyWith4BenefitsAndRidersWithVariantTypeAsCRCR(String clientName, String agreementNumberStringValue, String quotationDetailsStringValue, 
			...
			String freeCoverLimitValueForRider4, String minimumCapValue4, String maximumCapValue4) throws Throwable
	{
		...
		masterPolicyMakerPage.masterPolicyWith4BenefitsAndRidersWithVariantTypeAsCRCR(clientName, agreementNumberStringValue, 
				...
				varientType2, percentageofBaseBenefitValue2, freeCoverLimitValueForRider2, minimumCapValue2, maximumCapValue2, 
				benefits3, varientType3, freeCoverLimitValueForAdditionalRider, benefits4, varientType4, 
