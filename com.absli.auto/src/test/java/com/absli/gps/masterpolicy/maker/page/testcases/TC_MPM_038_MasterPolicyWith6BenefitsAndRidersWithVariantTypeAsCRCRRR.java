...
public class TC_MPM_038_MasterPolicyWith6BenefitsAndRidersWithVariantTypeAsCRCRRR extends AbsliBase {
	...
	@DataProvider(name="TestDataFromTC_MPM_038")
	public Object[][] getTestDataFromTestDataFromTC_MPM_038()
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_038.xlsx", "TC_MPM_038");
		return arrobj;			
	}
	
	@Test(priority = 37,dataProvider = "TestDataFromTC_MPM_038", dataProviderClass = TC_MPM_038_MasterPolicyWith6BenefitsAndRidersWithVariantTypeAsCRCRRR.class)
	public void createAMasterPolicyWith4BenefitsAndRidersWithVariantTypeAsCRCRRR (String clientName, String agreementNumberStringValue, String quotationDetailsStringValue, 
			...
			String benefits6, String varientType6, String percentageofBaseBenefitValue6, String freeCoverLimitValue6, String minimumCapValue6, String maximumCapValue6) throws Throwable
	{
		...
		masterPolicyMakerPage.masterPolicyWith6BenefitsAndRidersWithVariantTypeAsCRCRRR(clientName, 
				...
				reinsurerValue, UnitAddress, addressDetails, benefits1, varientType1, freeCoverLimitValueForBaseBenefit, 
				...
				freeCoverLimitValueForBaseBenefitForAdditionalRider, benefits4, varientType4, 
				percentageofBaseBenefitValue4, freeCoverLimitValue4, minimumCapValue4, maximumCapValue4, benefits5, 
				varientType5, percentageofBaseBenefitValue5, freeCoverLimitValue5, minimumCapValue5, maximumCapValue5, 
				benefits6, varientType6, percentageofBaseBenefitValue6, freeCoverLimitValue6, minimumCapValue6, 
				maximumCapValue6);
	}
