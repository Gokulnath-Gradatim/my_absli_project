...
public class TC_MPM_026_MasterPolicyWith5BenefitsAndRidersWithVariantTypeAsCRCRR extends AbsliBase {
	...
	@DataProvider(name="TestDataFromTC_MPM_026")
	public Object[][] getTestDataFromTestDataFromTC_MPM_026()
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_026.xlsx", "TC_MPM_026");
		return arrobj;			
	}
	
	@Test(priority = 25,dataProvider = "TestDataFromTC_MPM_026", dataProviderClass = TC_MPM_026_MasterPolicyWith5BenefitsAndRidersWithVariantTypeAsCRCRR.class)
	public void createAMasterPolicyWith4BenefitsAndRidersWithVariantTypeAsCRCRR (String clientName, String agreementNumberStringValue, String quotationDetailsStringValue, 
			...
			String benefits5, String varientType5, String percentageofBaseBenefitValue5, String freeCoverLimitValue5, String minimumCapValue5, String maximumCapValue5) throws Throwable
	{
		...
		masterPolicyMakerPage.masterPolicyWith5BenefitsAndRidersWithVariantTypeAsCRCRR(clientName, 
