...
public class TC_MPM_031_MasterPolicyWith6BenefitsAndRidersWithVariantTypeAsCRCCRC extends AbsliBase {
	...
	@DataProvider(name="TestDataFromTC_MPM_031")
	public Object[][] getTestDataFromTestDataFromTC_MPM_031()
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_031.xlsx", "TC_MPM_031");
		return arrobj;			
	}
	
	@Test(priority = 30,dataProvider = "TestDataFromTC_MPM_031", dataProviderClass = TC_MPM_031_MasterPolicyWith6BenefitsAndRidersWithVariantTypeAsCRCCRC.class)
	public void createAMasterPolicyWith4BenefitsAndRidersWithVariantTypeAsCRCCRC (String clientName, String agreementNumberStringValue, String quotationDetailsStringValue, 
			...
			String benefits6, String varientType6, String freeCoverLimitValue6) throws Throwable
	{
		...
		masterPolicyMakerPage.masterPolicyWith6BenefitsAndRidersWithVariantTypeAsCRCCRC(clientName, agreementNumberStringValue, 
				...
				UnitAddress, addressDetails, benefits1, varientType1, freeCoverLimitValueForBaseBenefit, benefits2, 
