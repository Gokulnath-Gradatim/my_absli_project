...
public class TC_MPM_091_MasterPolicyWith5BenefitsAndRidersWithVariantTypeAsFsaRRFsaFsa extends AbsliBase {
	...
	@DataProvider(name="TestDataFromTC_MPM_091")
	public Object[][] getTestDataFromTestDataFromTC_MPM_091()
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_091.xlsx", "TC_MPM_091");
		return arrobj;
			
	}
	
	@Test(priority = 90,dataProvider = "TestDataFromTC_MPM_091", dataProviderClass = TC_MPM_091_MasterPolicyWith5BenefitsAndRidersWithVariantTypeAsFsaRRFsaFsa.class)
	public void createAMasterPolicyWith5BenefitsAndRidersWithVariantTypeAsFsaRRFsaFsa (String clientName, String agreementNumberStringValue, String quotationDetailsStringValue, 
		...
		masterPolicyMakerPage.masterPolicyWith5BenefitsAndRidersWithVariantTypeAsFsaRRFsaFsa(clientName, agreementNumberStringValue, 
				...
				benefits4, varientType4, sumAssuredValue4, freeCoverLimitValue4, benefits5, varientType5, sumAssuredValue5, 
				freeCoverLimitValue5);
	}
