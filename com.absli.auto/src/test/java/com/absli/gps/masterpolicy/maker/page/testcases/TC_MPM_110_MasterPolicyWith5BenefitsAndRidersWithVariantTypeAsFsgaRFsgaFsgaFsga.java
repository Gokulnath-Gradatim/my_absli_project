...
public class TC_MPM_110_MasterPolicyWith5BenefitsAndRidersWithVariantTypeAsFsgaRFsgaFsgaFsga extends AbsliBase  {
	...
	@DataProvider(name="TestDataFromTC_MPM_110")
	public Object[][] getTestDataFromTestDataFromTC_MPM_110()
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_110.xlsx", "TC_MPM_110");
		return arrobj;
	}
	
	@Test(priority = 109,dataProvider = "TestDataFromTC_MPM_110", dataProviderClass = TC_MPM_110_MasterPolicyWith5BenefitsAndRidersWithVariantTypeAsFsgaRFsgaFsgaFsga.class)
	public void createAMasterPolicyWith5BenefitsAndRidersWithVariantTypeAsFsgaRFsgaFsgaFsga (String clientName, String agreementNumberStringValue, String quotationDetailsStringValue, 
		...
		masterPolicyMakerPage.masterPolicyWith5BenefitsAndRidersWithVariantTypeAsFsgaRFsgaFsgaFsga(clientName, 
				...
				retirementAgeValue5, maxSumAssuredValue5, freeCoverLimitValue5, minimumCapValue5, maximumCapValue5);
	}
