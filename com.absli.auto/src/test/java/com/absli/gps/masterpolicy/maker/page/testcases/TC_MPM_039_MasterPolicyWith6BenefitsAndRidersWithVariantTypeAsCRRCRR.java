...
public class TC_MPM_039_MasterPolicyWith6BenefitsAndRidersWithVariantTypeAsCRRCRR extends AbsliBase {
	...
	@DataProvider(name="TestDataFromTC_MPM_039")
	public Object[][] getTestDataFromTestDataFromTC_MPM_039()
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_039.xlsx", "TC_MPM_039");
		return arrobj;			
	}
	
	@Test(priority = 38,dataProvider = "TestDataFromTC_MPM_039", dataProviderClass = TC_MPM_039_MasterPolicyWith6BenefitsAndRidersWithVariantTypeAsCRRCRR.class)
	public void createAMasterPolicyWith4BenefitsAndRidersWithVariantTypeAsCRRCRR (String clientName, String agreementNumberStringValue, String quotationDetailsStringValue, 
			...
			String benefits6, String varientType6, String percentageofBaseBenefitValue6, String freeCoverLimitValue6, String minimumCapValue6, String maximumCapValue6) throws Throwable
	{
		...
		masterPolicyMakerPage.masterPolicyWith6BenefitsAndRidersWithVariantTypeAsCRRCRR(clientName, 
				...
				freeCoverLimitValue4, benefits5, varientType5, percentageofBaseBenefitValue5, freeCoverLimitValue5, 
				minimumCapValue5, maximumCapValue5, benefits6, varientType6, percentageofBaseBenefitValue6, 
				freeCoverLimitValue6, minimumCapValue6, maximumCapValue6);
	}
