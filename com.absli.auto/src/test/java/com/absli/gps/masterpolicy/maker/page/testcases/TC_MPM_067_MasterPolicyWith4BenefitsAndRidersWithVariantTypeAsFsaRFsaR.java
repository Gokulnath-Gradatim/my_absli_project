...
public class TC_MPM_067_MasterPolicyWith4BenefitsAndRidersWithVariantTypeAsFsaRFsaR extends AbsliBase {
	...
	@DataProvider(name="TestDataFromTC_MPM_067")
	public Object[][] getTestDataFromTestDataFromTC_MPM_067()
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_067.xlsx", "TC_MPM_067");
		return arrobj;
			
	}
	
	@Test(priority = 66,dataProvider = "TestDataFromTC_MPM_067", dataProviderClass = TC_MPM_067_MasterPolicyWith4BenefitsAndRidersWithVariantTypeAsFsaRFsaR.class)
	public void createAMasterPolicyWith4BenefitsAndRidersWithVariantTypeAsFsaRFsaR(String clientName, String agreementNumberStringValue, String quotationDetailsStringValue, 
			...
			String benefits4, String varientType4, String percentageofBaseBenefitValue4, String freeCoverLimitValue4, String minimumCapValue4, String maximumCapValue4) throws Throwable
	{
		...
		masterPolicyMakerPage.masterPolicyWith4BenefitsAndRidersWithVariantTypeAsFsaRFsaR(clientName, 
				...
				benefits3, varientType3, sumAssuredValueForAdditionalRider, freeCoverLimitValueForAdditionalRider, 
