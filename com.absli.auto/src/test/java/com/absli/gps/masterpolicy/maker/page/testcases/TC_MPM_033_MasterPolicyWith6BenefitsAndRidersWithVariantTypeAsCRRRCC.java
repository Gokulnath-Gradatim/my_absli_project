...
public class TC_MPM_033_MasterPolicyWith6BenefitsAndRidersWithVariantTypeAsCRRRCC extends AbsliBase {
	...
	@DataProvider(name="TestDataFromTC_MPM_033")
	public Object[][] getTestDataFromTestDataFromTC_MPM_033()
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_033.xlsx", "TC_MPM_033");
		return arrobj;			
	}
	
	@Test(priority = 32,dataProvider = "TestDataFromTC_MPM_033", dataProviderClass = TC_MPM_033_MasterPolicyWith6BenefitsAndRidersWithVariantTypeAsCRRRCC.class)
	public void createAMasterPolicyWith4BenefitsAndRidersWithVariantTypeAsCRRRCC (String clientName, String agreementNumberStringValue, String quotationDetailsStringValue, 
			...
			String benefits6, String varientType6, String freeCoverLimitValue6) throws Throwable
	{
		...
		masterPolicyMakerPage.masterPolicyWith6BenefitsAndRidersWithVariantTypeAsCRRRCC(clientName, 
