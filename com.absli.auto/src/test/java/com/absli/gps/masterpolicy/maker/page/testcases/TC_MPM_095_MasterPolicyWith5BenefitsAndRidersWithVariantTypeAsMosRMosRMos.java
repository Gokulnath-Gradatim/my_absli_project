...
public class TC_MPM_095_MasterPolicyWith5BenefitsAndRidersWithVariantTypeAsMosRMosRMos extends AbsliBase {
	...
	@DataProvider(name="TestDataFromTC_MPM_095")
	public Object[][] getTestDataFromTestDataFromTC_MPM_095()
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_095.xlsx", "TC_MPM_095");
		return arrobj;
	}
	
	@Test(priority = 94,dataProvider = "TestDataFromTC_MPM_095", dataProviderClass = TC_MPM_095_MasterPolicyWith5BenefitsAndRidersWithVariantTypeAsMosRMosRMos.class)
	public void createAMasterPolicyWith5BenefitsAndRidersWithVariantTypeAsMosRMosRMos (String clientName, String agreementNumberStringValue, String quotationDetailsStringValue, 
		...
		masterPolicyMakerPage.masterPolicyWith5BenefitsAndRidersWithVariantTypeAsMosRMosRMos(clientName, agreementNumberStringValue, 
