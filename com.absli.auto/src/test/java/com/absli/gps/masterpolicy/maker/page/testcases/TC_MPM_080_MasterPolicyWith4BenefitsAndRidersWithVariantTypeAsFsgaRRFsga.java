...
public class TC_MPM_080_MasterPolicyWith4BenefitsAndRidersWithVariantTypeAsFsgaRRFsga extends AbsliBase  {
	...
	@DataProvider(name="TestDataFromTC_MPM_080")
	public Object[][] getTestDataFromTestDataFromTC_MPM_080()
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_080.xlsx", "TC_MPM_080");
		return arrobj;
			
	}
	
	@Test(priority = 79,dataProvider = "TestDataFromTC_MPM_080", dataProviderClass = TC_MPM_080_MasterPolicyWith4BenefitsAndRidersWithVariantTypeAsFsgaRRFsga.class)
	public void createAMasterPolicyWith4BenefitsAndRidersWithVariantTypeAsFsgaRRFsga (String clientName, String agreementNumberStringValue, String quotationDetailsStringValue, 
		...
		masterPolicyMakerPage.masterPolicyWith4BenefitsAndRidersWithVariantTypeAsFsgaRRFsga(clientName, agreementNumberStringValue, 
				...
				retirementAgeValueForBaseBenefit, maxSumAssuredValueForBaseBenefit, freeCoverLimitValueForBaseBenefit, 
				...
				freeCoverLimitValueForAdditionalRider, minimumCapValueForAdditionalRider, maximumCapValueForAdditionalRider, benefits4, 
				varientType4, retirementAgeValue4, maxSumAssuredValue4, freeCoverLimitValue4, minimumCapValue4, maximumCapValue4);
	}
	@AfterMethod
	public void endUp()
	{
