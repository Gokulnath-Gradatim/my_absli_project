...
public class TC_MPM_032_MasterPolicyWith6BenefitsAndRidersWithVariantTypeAsCRCCCR extends AbsliBase {
	...
	@DataProvider(name="TestDataFromTC_MPM_032")
	public Object[][] getTestDataFromTestDataFromTC_MPM_032()
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_032.xlsx", "TC_MPM_032");
		return arrobj;			
	}
	
	@Test(priority = 31,dataProvider = "TestDataFromTC_MPM_032", dataProviderClass = TC_MPM_032_MasterPolicyWith6BenefitsAndRidersWithVariantTypeAsCRCCCR.class)
	public void createAMasterPolicyWith4BenefitsAndRidersWithVariantTypeAsCRCCCR (String clientName, String agreementNumberStringValue, String quotationDetailsStringValue, 
			...
			String benefits6, String varientType6, String percentageofBaseBenefitValue6, String freeCoverLimitValue6, String minimumCapValue6, String maximumCapValue6) throws Throwable
	{
		...
		masterPolicyMakerPage.masterPolicyWith6BenefitsAndRidersWithVariantTypeAsCRCCCR(clientName, 
				...
				varientType5, freeCoverLimitValue5, benefits6, varientType6, percentageofBaseBenefitValue6, 
