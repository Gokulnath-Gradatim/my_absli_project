...
public class TC_MPM_078_MasterPolicyWith4BenefitsAndRidersWithVariantTypeAsFsgaRFsgaFsga extends AbsliBase {
	...
	@DataProvider(name="TestDataFromTC_MPM_078")
	public Object[][] getTestDataFromTestDataFromTC_MPM_078()
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_078.xlsx", "TC_MPM_078");
		return arrobj;
			
	}
	
	@Test(priority = 77,dataProvider = "TestDataFromTC_MPM_078", dataProviderClass = TC_MPM_078_MasterPolicyWith4BenefitsAndRidersWithVariantTypeAsFsgaRFsgaFsga.class)
	public void createAMasterPolicyWith4BenefitsAndRidersWithVariantTypeAsFsgaRFsgaFsga(String clientName, String agreementNumberStringValue, String quotationDetailsStringValue, 
		...
		masterPolicyMakerPage.masterPolicyWith4BenefitsAndRidersWithVariantTypeAsFsgaRFsgaFsga(clientName, 
				...
				maxSumAssuredValue4, freeCoverLimitValue4, minimumCapValue4, maximumCapValue4);
	}
	@AfterMethod
	public void endUp()
	{
