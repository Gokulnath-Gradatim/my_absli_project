...
public class TC_MPM_087_MasterPolicyWith5BenefitsAndRidersWithVariantTypeAsFsaRFsaRFsa  extends AbsliBase {
	...
	@DataProvider(name="TestDataFromTC_MPM_087")
	public Object[][] getTestDataFromTestDataFromTC_MPM_087()
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_087.xlsx", "TC_MPM_087");
		return arrobj;
			
	}
	
	@Test(priority = 86,dataProvider = "TestDataFromTC_MPM_087", dataProviderClass = TC_MPM_087_MasterPolicyWith5BenefitsAndRidersWithVariantTypeAsFsaRFsaRFsa.class)
	public void createAMasterPolicyWith5BenefitsAndRidersWithVariantTypeAsFsaRFsaRFsa (String clientName, String agreementNumberStringValue, String quotationDetailsStringValue, 
		...
		masterPolicyMakerPage.masterPolicyWith5BenefitsAndRidersWithVariantTypeAsFsaRFsaRFsa(clientName, agreementNumberStringValue, 
				...
				minimumCapValue4, maximumCapValue4, benefits5, varientType5, sumAssuredValue5, freeCoverLimitValue5);
