...
public class TC_MPM_025_MasterPolicyWith5BenefitsAndRidersWithVariantTypeAsCRRCC extends AbsliBase {
	...
	@DataProvider(name="TestDataFromTC_MPM_025")
	public Object[][] getTestDataFromTestDataFromTC_MPM_025()
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_025.xlsx", "TC_MPM_025");
		return arrobj;			
	}
	
	@Test(priority = 24,dataProvider = "TestDataFromTC_MPM_025", dataProviderClass = TC_MPM_025_MasterPolicyWith5BenefitsAndRidersWithVariantTypeAsCRRCC.class)
	public void createAMasterPolicyWith4BenefitsAndRidersWithVariantTypeAsCRRCC (String clientName, String agreementNumberStringValue, String quotationDetailsStringValue, 
			...
			String benefits5, String varientType5, String freeCoverLimitValue5) throws Throwable
	{
		...
		masterPolicyMakerPage.masterPolicyWith5BenefitsAndRidersWithVariantTypeAsCRRCC(clientName, 
				...
				freeCoverLimitValue4, benefits5, varientType5, freeCoverLimitValue5);
	}
