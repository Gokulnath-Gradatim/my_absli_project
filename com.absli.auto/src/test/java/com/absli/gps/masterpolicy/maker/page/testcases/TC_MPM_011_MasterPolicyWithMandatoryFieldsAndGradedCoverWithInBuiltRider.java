...
public class TC_MPM_011_MasterPolicyWithMandatoryFieldsAndGradedCoverWithInBuiltRider extends AbsliBase {
			...
			String minimumCapValueForRider, String maximumCapValueForRider) throws Throwable
	{
		...
		masterPolicyMakerPage.masterPolicyWithMandatoryFieldsAndGradedCoverWithInBuiltRider(clientName, agreementNumberStringValue, 
				...
				varientType1, noOfGrade, gradeValue1, sumAssuredValue1, freeCoverLimitValue1, minimumCapValue1, maximumCapValue1, 
				gradeValue2, sumAssuredValue2, freeCoverLimitValue2, minimumCapValue2, maximumCapValue2, gradeValue3, 
				sumAssuredValue3, freeCoverLimitValue3, minimumCapValue3, maximumCapValue3, benefits2, varientType2, 
