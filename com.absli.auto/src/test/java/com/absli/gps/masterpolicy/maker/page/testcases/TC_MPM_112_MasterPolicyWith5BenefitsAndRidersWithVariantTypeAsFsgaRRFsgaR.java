...
public class TC_MPM_112_MasterPolicyWith5BenefitsAndRidersWithVariantTypeAsFsgaRRFsgaR extends AbsliBase {
	...
	@DataProvider(name="TestDataFromTC_MPM_112")
	public Object[][] getTestDataFromTestDataFromTC_MPM_112()
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_112.xlsx", "TC_MPM_112");
		return arrobj;
	}
	
	@Test(priority = 111,dataProvider = "TestDataFromTC_MPM_112", dataProviderClass = TC_MPM_112_MasterPolicyWith5BenefitsAndRidersWithVariantTypeAsFsgaRRFsgaR.class)
	public void createAMasterPolicyWith5BenefitsAndRidersWithVariantTypeAsFsgaRRFsgaR (String clientName, String agreementNumberStringValue, String quotationDetailsStringValue, 
		...
		masterPolicyMakerPage.masterPolicyWith5BenefitsAndRidersWithVariantTypeAsFsgaRRFsgaR(clientName, agreementNumberStringValue, 
				...
				benefits4, varientType4, retirementAgeValue4, maxSumAssuredValue4, freeCoverLimitValue4, minimumCapValue4, 
				maximumCapValue4, benefits5, varientType5, percentageofBaseBenefitValue5, freeCoverLimitValue5, minimumCapValue5, 
				maximumCapValue5);
	}
