...
public class TC_MPM_068_MasterPolicyWith4BenefitsAndRidersWithVariantTypeAsFsaRRFsa extends AbsliBase {
	...
	@DataProvider(name="TestDataFromTC_MPM_068")
	public Object[][] getTestDataFromTestDataFromTC_MPM_068()
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_068.xlsx", "TC_MPM_068");
		return arrobj;
			
	}
	
	@Test(priority = 67,dataProvider = "TestDataFromTC_MPM_068", dataProviderClass = TC_MPM_068_MasterPolicyWith4BenefitsAndRidersWithVariantTypeAsFsaRRFsa.class)
	public void createAMasterPolicyWith4BenefitsAndRidersWithVariantTypeAsFsaRRFsa(String clientName, String agreementNumberStringValue, String quotationDetailsStringValue, 
			...
			String benefits4, String varientType4, String sumAssuredValue4, String freeCoverLimitValue4) throws Throwable
	{
		...
		masterPolicyMakerPage.masterPolicyWith4BenefitsAndRidersWithVariantTypeAsFsaRRFsa(clientName, 
				...
				reinsurerValue, unitAddress, addressDetails, benefits1, varientType1, sumAssuredValueForBaseBenefit, 
				freeCoverLimitValueForBaseBenefit, benefits2, varientType2, percentageofBaseBenefitValueForInbuildRider, 
				...
				sumAssuredValue4, freeCoverLimitValue4);
	}
