...
public class TC_MPM_084_MasterPolicyWith4BenefitsAndRidersWithVariantTypeAsGcsmRRGcsm extends AbsliBase  {
	...
	@DataProvider(name="TestDataFromTC_MPM_084")
	public Object[][] getTestDataFromTestDataFromTC_MPM_084()
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_084.xlsx", "TC_MPM_084");
		return arrobj;
			
	}
	
	@Test(priority = 83,dataProvider = "TestDataFromTC_MPM_084", dataProviderClass = TC_MPM_084_MasterPolicyWith4BenefitsAndRidersWithVariantTypeAsGcsmRRGcsm.class)
	public void createAMasterPolicyWith4BenefitsAndRidersWithVariantTypeAsGcsmRRGcsm (String clientName, String agreementNumberStringValue, String quotationDetailsStringValue, 
		...
		masterPolicyMakerPage.masterPolicyWith4BenefitsAndRidersWithVariantTypeAsGcsmRRGcsm(clientName, agreementNumberStringValue, 
				...
				freeCoverLimitValueForFourthRider3, minimumCapValueForFourthRider3, maximumCapValueForFourthRider3);
	}
	@AfterMethod
	public void endUp()
	{
