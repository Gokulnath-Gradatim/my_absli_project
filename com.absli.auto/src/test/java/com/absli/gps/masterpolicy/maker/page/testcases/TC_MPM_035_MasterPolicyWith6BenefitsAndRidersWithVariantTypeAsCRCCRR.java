...
public class TC_MPM_035_MasterPolicyWith6BenefitsAndRidersWithVariantTypeAsCRCCRR extends AbsliBase {
	...
	@DataProvider(name="TestDataFromTC_MPM_035")
	public Object[][] getTestDataFromTestDataFromTC_MPM_035()
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_035.xlsx", "TC_MPM_035");
		return arrobj;			
	}
	
	@Test(priority = 34,dataProvider = "TestDataFromTC_MPM_035", dataProviderClass = TC_MPM_035_MasterPolicyWith6BenefitsAndRidersWithVariantTypeAsCRCCRR.class)
	public void createAMasterPolicyWith4BenefitsAndRidersWithVariantTypeAsCRCCRR (String clientName, String agreementNumberStringValue, String quotationDetailsStringValue, 
			...
			String benefits6, String varientType6, String percentageofBaseBenefitValue6, String freeCoverLimitValue6, String minimumCapValue6, String maximumCapValue6) throws Throwable
	{
		...
		masterPolicyMakerPage.masterPolicyWith6BenefitsAndRidersWithVariantTypeAsCRCCRR(clientName, 
