...
public class TC_MPM_030_MasterPolicyWith6BenefitsAndRidersWithVariantTypeAsCRCRCC extends AbsliBase {
	...
	@DataProvider(name="TestDataFromTC_MPM_030")
	public Object[][] getTestDataFromTestDataFromTC_MPM_030()
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_030.xlsx", "TC_MPM_030");
		return arrobj;			
	}
	
	@Test(priority = 29,dataProvider = "TestDataFromTC_MPM_030", dataProviderClass = TC_MPM_030_MasterPolicyWith6BenefitsAndRidersWithVariantTypeAsCRCRCC.class)
	public void createAMasterPolicyWith4BenefitsAndRidersWithVariantTypeAsCRCRCC (String clientName, String agreementNumberStringValue, String quotationDetailsStringValue, 
			...
			String benefits6, String varientType6, String freeCoverLimitValue6) throws Throwable
	{
		...
		masterPolicyMakerPage.masterPolicyWith6BenefitsAndRidersWithVariantTypeAsCRCRCC(clientName, 
				agreementNumberStringValue, quotationDetailsStringValue, title, firstName, number, 
				emailIDStringValue, numberOfInsured, totalSumAssuredStringValue, inceptionDateValue, 
				agentCodeValue, brokerageUpdationValue, varient, conditionsValue, benefitType, typeOfRenewal, 
				windowPeriodValue, nraLetterReceived, retirementAgeValue, nraLetterReceivedDateValue, typeOfClient, 
				frequency, zone, minimumAge, maximumAge, reinsurerValue, UnitAddress, addressDetails, benefits1, 
				varientType1, freeCoverLimitValueForBaseBenefit, benefits2, varientType2, 
				...
				freeCoverLimitValueForAdditionalRider, benefits4, varientType4, percentageofBaseBenefitValue4, 
				freeCoverLimitValue4, minimumCapValue4, maximumCapValue4, benefits5, varientType5, 
				freeCoverLimitValue5, benefits6, varientType6, freeCoverLimitValue6);
	}
